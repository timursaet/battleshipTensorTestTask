define(() => {
    ...
    class controller {
        ...
        inits() {
            ...
            this.el.info.innerHTML = this.renderInfo();
            document.querySelector(".game").appendChild(this.el.info);
            this.el.button.innerHTML = this.renderSurrendButton();
        ...
        renderInfo() {
            return `Логи игры
                    <div class="game__informer">
                        <textarea readonly autofocus class="game__informer-text"></textarea>
                    </div>`;
        }
         ...
         */
            ...
            this.el.button = document.createElement('div');
            this.el.button.className = "game__buttons";
            this.el.button.innerHTML = this.renderAgainButton();
            document.querySelector(".game").appendChild(this.el.button);
            this.removeListener();
            if (player == 0) {
